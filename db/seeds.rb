...
bourgeois = User.create(password: pw, spiders@IndieExpo.com, bio: "French-American artist. Best known for her large-scale sculpture and installation art, Bourgeois was also a prolific painter and printmaker. She explored a variety of themes over the course of her long career including domesticity and the family, and the body, as well as death and the subconscious. Although Bourgeois exhibited with the Abstract Expressionists and her work has much in common with Surrealism and Feminist art, she was not formally affiliated with a particular artistic movement.", first_name: "Louise", last_name: "Bourgeois", image_url: "https://res.cloudinary.com/dy4gcvjff/image/upload/q_auto:eco/v1501277805/pexels-photo-211816_tflrpy.jpg")
sissa = User.create(password: pw, grainsowheat@IndieExpo.com, bio: "Legendary inventor of chess." first_name: "Sissa", last_name: "ibn Dahir", image_url: "https://res.cloudinary.com/dy4gcvjff/image/upload/q_auto:eco/v1501278425/pexels-photo-57018_xbak30.jpg")
 hillyer = User.create(password: pw, juleshillyer@IndieExpo.com, bio: "Tinkerer. Mechanic. Inventor. Travel Journalist.", first_name: "Jules", last_name: " Mr. Hillyer", image_url: "https://res.cloudinary.com/dy4gcvjff/image/upload/q_auto:eco/v1501281512/sidney-perry-105613_edydkp.jpg")
...
stressgames = Campaign.create(title: 'TableTop EnJoyable', goal: 37000, creator_id: sissa.id, category_id: games.id, tagline: "Alleviate stress with clinically tested board games", city: "Austin", country: "USA", duration: 30, overview: lorem, pitch: "We are researching and designing a series of games designed to help people with PTSD and social anxiety. The games will be made with a carefully selected, soothing color pallet, and warm, reassuring materials.", body: lorem, image_urls: ["https://res.cloudinary.com/dy4gcvjff/image/upload/q_auto:eco/v1501278817/pexels-photo-208147_zzbz5i.jpg", "https://res.cloudinary.com/dy4gcvjff/image/upload/q_auto:eco/v1501278814/pexels-photo-262488_gpkhro.jpg", "https://res.cloudinary.com/dy4gcvjff/image/upload/q_auto:eco/v1501278656/pexels-photo-209640_nuareg.jpg", "https://res.cloudinary.com/dy4gcvjff/image/upload/q_auto:eco/v1501278656/pexels-photo-220053_kmilgg.jpg", "https://res.cloudinary.com/dy4gcvjff/image/upload/q_auto:eco/v1501278434/yanni-panesa-216327_zf71pu.jpg"])
